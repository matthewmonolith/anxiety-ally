  ...
  <Container maxW={'7xl'}>
    ...
    >
      <Stack flex={1} spacing={{ base: 5, md: 10 }}>
        ...
        <Text color={'gray.500'}>
            All it takes is to create a free account to access all the features of Anxiety Ally. No subscriptions, no hidden fees, we promise it is completely free forever.
        </Text>
